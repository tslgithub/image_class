# 图像分类集成以下模型： VGG16、VGG19、InceptionV3、Xception、MobileNet、AlexNet、LeNet、ZF_Net、ResNet18、ResNet34、ResNet50、ResNet101、ResNet152，mnist_net,TSL16等网络，在config.py里面选择使用哪种模型，目前本人亲测，在本人的应用场景中，残差网络resnet的效果比较好。
